...
from adminpanel.views import AdminHub,addQuiz,dbAddQuiz,dbAddExam,addExam
...
urlpatterns = [
    ...
    path('adminuser/<int:user_id>/examadd',dbAddExam , name = "addExamForm" ),
    path ('adminuser/<int:user_id>/adding',addExam,name = "addExams")
]
